...
/*
Plugin Name: MyFontsWebfontsKit #254858
...
add_action( 'admin_init', array('MyFontsInstaller_254858','checkInstallation'));
add_action( 'wp_enqueue_scripts', array('MyFontsInstaller_254858','myfonts_loadupWebfonts' ));
